      ...
      {RATING_STEPS.map((step) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex min-h-11 flex-1 flex-col items-center justify-center gap-1 rounded-lg border border-border px-1 py-2.5 text-caption transition-colors disabled:opacity-50 md:min-h-0",

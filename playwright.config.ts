...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      // projects.spec.ts, and mobile.spec.ts (whose journal and weekly-summary
      // cases write real rows) seed/create/clear real rows (calendar-sync.spec.ts's
      ...
      testIgnore:
        /(calendar|calendar-sync|event-management|drag-reschedule|agenda|board|scripts|content-links|streams|publish-checklist|journal|weekly-summary|weekly-assessment|projects|mobile)\.spec\.ts$/,
    },
  ],
  webServer: [
    {

...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      // drag-reschedule.spec.ts, and agenda.spec.ts seed/create/clear real
      // rows (calendar-sync.spec.ts's connection rows are also
      ...
      // this project would race against the chromium project's runs
      // against the same shared DB.
      testIgnore:
        /(calendar|calendar-sync|event-management|drag-reschedule|agenda)\.spec\.ts$/,
    },
  ],
  webServer: [
    {
